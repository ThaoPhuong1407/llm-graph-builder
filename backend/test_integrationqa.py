...
def run_tests():
   final_list = []
   error_list = []
   # ,'openai_gpt_4o','openai_gpt_4o_mini','azure-ai-gpt-35','azure-ai-gpt-4o','gemini_1_5_pro','gemini_1_5_flash','anthropic-claude-3-5-sonnet','bedrock-claude-3-5-sonnet','groq-llama3-70b','fireworks-llama-v3-70b'
   models = ['openai_gpt_3_5']
   ...
   for model_name in models:
       try:
                ...
                # final_list.append(test_chatbotc_qna(model_name, mode='graph+vector'))
